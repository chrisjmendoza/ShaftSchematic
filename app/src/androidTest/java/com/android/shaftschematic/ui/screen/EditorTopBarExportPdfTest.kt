    ...
    fun exportPdf_disabledWhenNoComponents_andShowsMessageOnTap() {
        ...
        composeRule.setContent {
            ...
            ShaftScreen(
                ...
                onSelectPresentationById = {},
                onBeginDraftBody = { _, _, _ -> },
                onBeginDraftTaper = { _, _, _, _ -> },
                onBeginDraftThread = { _, _, _, _, _ -> },
                onBeginDraftLiner = { _, _, _ -> },
                onUpdateDraftBody = { _, _, _ -> },
                onUpdateDraftTaper = { _, _, _, _ -> },
                onUpdateDraftTaperOrientation = {},
                onUpdateDraftTaperKeyway = { _, _, _, _ -> },
                onUpdateDraftThread = { _, _, _, _, _ -> },
                onUpdateDraftLiner = { _, _, _ -> },
                onCommitDraftComponent = {},
                onCancelDraftComponent = {},
                onUpdateBody = { _, _, _, _ -> },
                onUpdateTaper = { _, _, _, _, _ -> },
                onUpdateTaperOrientation = { _, _ -> },
                onUpdateTaperKeyway = { _, _, _, _, _ -> },
                onUpdateThread = { _, _, _, _, _ -> },
                onUpdateLiner = { _, _, _, _ -> },
                onUpdateLinerLabel = { _, _ -> },
                onUpdateLinerReference = { _, _ -> },
                onUpdateAutoBodyOverride = { _, _ -> },
                onRemoveAutoBodyOverride = {},
