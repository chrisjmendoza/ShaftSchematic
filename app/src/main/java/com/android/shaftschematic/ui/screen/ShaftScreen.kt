...
fun ShaftScreen(
    ...
    onBeginDraftThread: (startMm: Float, lengthMm: Float, majorDiaMm: Float, pitchMm: Float, excludeFromOAL: Boolean) -> Unit,
                    ...
                    OutlinedTextField(
                        ...
                        keyboardActions = KeyboardActions(onDone = {
                            ...
                            if (t.isEmpty()) {
                                ...
                                val effective = computeOalWindow(spec).oalMm.toFloat()
