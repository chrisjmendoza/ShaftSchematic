...
LIVE-tuning channel — their own controls (wear: trace depth + wear-area shade; both:
blank draft) commit on release and re-render the whole page — so they keep the plain 78%
cap with the centered full-size page. Liners follow `shadedLiners` like
